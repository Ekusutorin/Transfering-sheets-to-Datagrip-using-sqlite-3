# Importing-sheets-to-Datagrip-using-sqlite-3
...
* You are gonna go to datagrip and add a new data source from the plus sign over on the database explorer and add a sqlite source(search for it around the bottom of the drop down menu, if sqlite is not in your recents
...
<img width="969" alt="Screen Shot 2021-12-31 at 12 02 47 PM" src="https://user-images.githubusercontent.com/77177531/147833414-d61ec18b-d8ba-447f-b82a-6180e8ae4d87.png">
...
* if that does happen, refactor the .tsv to .csv. ,you are most probably using a .tsv and its gving you issues, that was my case, so refactor the file from .tsv to .csv, that should do the trick
...
*  Also click the top left plus and add the .csv or .tsv that you initially added for your data sources and drivers, and then import it on the execute section, after that hit apply and ok
